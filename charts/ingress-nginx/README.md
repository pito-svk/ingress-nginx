...
| `controller.image.pullPolicy`                      | This will be used as the Elasticsearch [cluster.name][] and should be unique per cluster in the namespace                                                                                                                                                 | `controller.image.runAsUser`                                 |
| `controller.image.allowPrivilegeEscalation`               | Set to false to disabling service links, which can cause slow pod startup times when there are many services in the current namespace.                                                                                                                    | `true`                                          |
